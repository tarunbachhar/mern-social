    ...
    if (displaySocialInputs) {
      socialInputs = (
        <div>
          ...
          <InputGroup
            placeholder="LindedIn profile url"
            name="linkedin"
            ...
            <div className="col-md-8 m-auto">
              ...
              <form onSubmit={this.onSubmit}>
                <TextFieldGroup
                  ...
                  onChange={this.onChange}
                  error={errors.handle}
                  info="A unique ulr for your profile uRL. Your full name, company name, nickname"
                />
                <SelectListGroup
                  placeholder="Status"
                  name="status"
                ...
                <TextFieldGroup
                  ...
                  info="If you want your latest repos then add the link"
                />
                <TextAreaFieldGroup
